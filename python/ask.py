...
def main():
    ...
    print(f"Input Tokens:  {gpt_result['input_tokens']}")
    print(f"Output Tokens: {gpt_result['output_tokens']}")
    print(f"Latency:       {gpt_result['latency']}s")
    print(f"Cached:        {gpt_result['cached']}")
    print(f"\nAnswer:\n{gpt_result['answer']}")
    ...
    print(f"Latency:       {claude_result['latency']}s")
    print(f"Cached:        {claude_result['cached']}")
